...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Parth Gandhi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Programmer and Developer</h3>
        <p className="home__description">I'm a creative and passionate 
        web developer with a keen interest in data analysis.
        </p>
